...
function constructOdontogram(){
  $("#tr").append(`<?php echo $pat["tr"]; ?>`);
  $("#tl").append(`<?php echo $pat["tl"]; ?>`);
  $("#tlr").append(`<?php echo $pat["tlr"]; ?>`);
  $("#tll").append(`<?php echo $pat["tll"]; ?>`);
  $("#bl").append(`<?php echo $pat["bl"]; ?>`);
  $("#br").append(`<?php echo $pat["br"]; ?>`);
  $("#bll").append(`<?php echo $pat["bll"]; ?>`);
  $("#blr").append(`<?php echo $pat["blr"]; ?>`);
}
//crea odontograma
...
$(document).ready(function() {
    ...
    $(".click").click(function(event) {
        ...
        switch (control) {
            ...
            abajo=false;
            udt=false;
            matriz[i][j][type[p]]=p+'caries';//para guardar
            if(i=='8' || i=='7' || i=='4' || i=='3')
              abajo=true;
            if(j=='1' || j=='2' || j=='3')
              udt=true;
            ...
            case "restauracion":
                ...
                abajo=false;
                udt=false;
                matriz[i][j][type[p]]=p+'obturado';//para guardar
                if(i=='8' || i=='7' || i=='4' || i=='3')
                  abajo=true;
                if(j=='1' || j=='2' || j=='3')
                  udt=true;
            ...
            case "extraccion":
                ...
                j=desc.substring(1);
                matriz[i][j][5]='necrosispulpar';//para guardar
                isdelete=false;
            ...
            case "corona":
                ...
                i=desc.substring(0,1);
                j=desc.substring(1);
                matriz[i][j][5]='corona';//para guardar
                isdelete=false;
            ...
            case "extraer":
                ...
                i=desc.substring(0,1);
                j=desc.substring(1);
                matriz[i][j][5]='exodonciaindicada';//para guardar
                isdelete=false;
            ...
            case "sellados":
                ...
                i=desc.substring(0,1);
                j=desc.substring(1);
                matriz[i][j][5]='sellados';//para guardar
                isdelete=false;
                for (var x = 0; x < optiondelete2.length; x++) {
            ...
            case "perdido":
                ...
                i=desc.substring(0,1);
                j=desc.substring(1);
                matriz[i][j][5]='perdidoausente';//para guardar
                isdelete=false;
                for (var x = 0; x < optiondelete2.length; x++) {
