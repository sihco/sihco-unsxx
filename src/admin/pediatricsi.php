                                      ...
                                      <div class="container">
                                        ...
                                        <div class="row border">
                                          ...
                                          <div class="col-4 border">
                                            ...
                                            Fecha:
                                            <input type="date" id="date1" name="date1" value="<?php if(isset($pat['date1'])){echo $pat['date1'];}else{echo date("Y-m-d");}?>" min="2015-01-01" max="2099-01-01">
                                          </div>
                                        </div>
                                        <div class="">
                                    ...
                                    <div class="from-group border border-warning rounded">
                                      <div class="container">
                                        <div class="row border">
                                          ...
                                          <div class="col-4 border">
                                            Fecha:
                                            <input type="date" id="date2" name="date2" value="<?php if(isset($pat['date2'])) echo $pat['date2'];?>" min="2015-01-01" max="2099-01-01">
                                          </div>
                                        </div>
                                        <div class="">
                                      ...
                                      <div class="container">
                                        <div class="row border">
                                          ...
                                          <div class="col-4 border">
                                            ...
                                            Fecha:
                                            <input type="date" id="date3" name="date3" value="<?php if(isset($pat['date3'])) echo $pat['date3'];?>" min="2015-01-01" max="2099-01-01">
                                          </div>
                                        </div>
                                        <div class="">
                                    ...
                                    if($i==0){
                                      echo "<div id=\"informationurgencias\">".
                                        ...
                                        "<div class=\"row\">".
                                          ...
                                          "<div class=\"col-3\">".
                                          "  <input type=\"date\" id=\"\" class=\"form-control d-inline urgfecha\" readonly onmousedown=\"return false;\" name=\"urgfecha[]\" value=\"\" min=\"2015-01-01\" max=\"2099-01-01\">".
                                          "</div>".
                                          "<div class=\"col-2\">".
                                          "  <input type=\"text\" class=\"form-control d-inline urgpieza\"  readonly onmousedown=\"return false;\" name=\"urgpieza[]\" >".
                                          "</div>".
                                          "<div class=\"col-2\">".
                                            "<textarea name=\"urgdiagnostico[]\" rows=\"2\" class=\"form-control d-inline urgdiagnostico\" readonly onmousedown=\"return false;\"></textarea>".
                                          "</div>".
                                          "<div class=\"col-2\">".
                                          "  <input type=\"text\" class=\"form-control d-inline urgtratamiento\" name=\"urgtratamiento[]\" readonly onmousedown=\"return false;\">".
                                          "</div>".
                                        "</div>".
                                      "</div>";
                                    }
