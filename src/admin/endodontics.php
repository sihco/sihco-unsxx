...
if(isset($_POST['desc']) && isset($_POST['evaluated']) &&
  isset($_POST['status']) && isset($_POST['id'])){
    if($_POST['status']=='--'){
        ...
        ForceLoad('endodontics.php?id='.$_POST['id']);
    }
    $accepted='f';
    if($_POST['status']=='end')
      $accepted='t';
  ...
  DBEvaluateEndodontics($_POST['desc'], $_POST['evaluated'], $accepted, $_POST['status'], $_POST['id']);
  MSGError('Se guardó la revisión');
}
if(isset($_GET['id']) && $_GET['id']!=""){
  //echo "sadf";
  $f=DBEndodonticsInfo2($_GET['id']);
  $pat=DBEndodonticsInfo($_GET['id']);
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="border border-primary">
                          <form class="" action="endodontics.php" method="post">
                              ...
                              <table class="table table-bordered table-hover">
                                ...
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <?php
                                      echo " <a href=\"#\" class=\"btn btn-sm btn-primary\" style=\"font-weight:bold\" onClick=\"window.open('reportendodontics.php?id=".$f['ficha']."#toolbar=0', ".
                            ...
                            <div class="modal-body">
                              <div class="row">
                                <div class="col-12">
                                  ...
                                  <textarea name="materialtext" id="materialtext" class="form-control" rows="8" cols="80"><?php if($pat['endodonticsmaterial']) echo $pat["endodonticsmaterial"]; ?></textarea>
                                </div>
                              </div>
                            </div>
                                          ...
                                          <tbody>
                                              ...
                                              if(isset($pat['tableprocedures'])&&isset($pat['tableprocedures']['pieza'])&&$pat['tableprocedures']){
                                                ...
                                                for ($i=0; $i < $size; $i++) {
                                                  ...
                                                  $firm=explode('=', $pat['tableprocedures']['caries'][$i]);
                                                  if($firm[0]==''){
                                                    $content.="<td></td>";
                                                  }else{
                                                    if($firm[0]=='t'){
                                                      $content.="<td>".
                                                      "  <input class=\"form-check-input ml-1\" name=\"caries[]\" type=\"checkbox\" value=\"$i\" checked>".
                                                      "  <div class=\"ml-4\">".
