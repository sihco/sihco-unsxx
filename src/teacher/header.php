...
<html lang="en">
    <head>
        ...
        if(!isset($_POST['noflush']))
            ob_end_flush();
        if(!ValidSession()){
            InvalidSession("teacher/index.php");////funcion para expirar el session y registar 3= debug en logtable
            ForceLoad("../index.php");//index.php
        }

        if($_SESSION["usertable"]["usertype"] != "teacher"){//system
            IntrusionNotify("teacher/index.php");
            ForceLoad("../index.php");//index.php
        }
        ?>
    </head>
