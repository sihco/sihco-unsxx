...
<div class="card p-2 shadow rounded text-half">
  ...
  <div class="row readtext">
    ...
    <div class="col-2">
      ...
      <span class="text-secondary">
        <?php if(isset($pat["patientgender"])) echo ucfirst($pat['patientgender']);?>
      </span>
    </div>
    <div class="col-3">
      <label for=""><b>Estado Civil:</b></label>&nbsp;&nbsp;&nbsp;
      <span class="text-secondary">
        <?php  if(isset($pat["patientcivilstatus"])) echo ucfirst($pat['patientcivilstatus']);?>
      </span>
    </div>
  </div>
