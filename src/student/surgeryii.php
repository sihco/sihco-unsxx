...
<div class="card p-3 shadow rounded text-half">
  ...
  <div class="row">
    ...
    <div class="col-lg-2 col-md-2 col-sm-6 col-6" align ="left">
      <span style="cursor: pointer;"class="text-primary fst-italic" data-bs-toggle="collapse" data-bs-target="#fulldatapatient" aria-expanded="true" aria-controls="fulldatapatient">mas info<div style="margin-top:-5px;" class="border border-primary row" id="divfull"> <div class="col-4  pt-2 bg-primary"></div> </div></span>
    </div>
  </div>

  <div id="fulldatapatient" class="accordion-collapse collapse" aria-labelledby="fulldatapatient">
  ...
  <div class="row">
    ...
    <div class="col-lg-6 col-md-6 col-sm-11 col-11">
      <div class="input-group input-group-sm mb-3">
        <label class="input-group-text" for="disease">Antecedentes psicotraumáticos del paciente</label>
        <input type="text" class="form-control" name="disease" id="disease" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" value="<?php if(isset($pat["surgeryiidisease"])) echo $pat["surgeryiidisease"];  ?>">
      </div>
    </div>
  </div>
  <div class="row">
